...
import { OrderState, orderStateList } from '@/services/constans'
import { ref } from 'vue'
...
// 获取页面栈   顶部左上角展示主页还是左箭头按钮
const pages = getCurrentPages()
// #ifdef MP-WEIXIN
// 获取当前页面实例，数组最后一项
const pageInstance = pages.at(-1) as any

// 页面渲染完毕，绑定动画效果   注意一定要绑定class/id类名
// 官方地址  https://developers.weixin.qq.com/miniprogram/dev/framework/view/animation.html
onReady(() => {
  // 动画效果  导航栏背景色
...
const onOrderPay = async () => {
  ...
  if (import.meta.env.DEV) {
    ...
    wx.requestPayment((await res).result)
  }
  // 关闭当前页面，在跳转支付结果页
